package io.lb.pokemon.security.data.model
...
data class TokenConfig(
    ...
    companion object {
        /**
         * Default TokenConfig for the Pokeman project.
         *
         * @param config Represents an application config node.
         * @param embedded Represents whether the server is embbeded.
         *
         * @return A TokenConfig instance with the default values for the Pokeman project.
         */
        fun tokenConfig(
